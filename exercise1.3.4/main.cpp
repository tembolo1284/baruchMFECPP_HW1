...
is interpreted as TRUE. The C-program can be made easier to read when this 0 (or no-zero) is assigned to a variable e.g.
...
int main()
{
	...
	int married = 1; // 1 here will mean someone is married
	
	printf("It look likes someone is %s", married ? "married.\n" : "not married.\n");

	
	//here we set married to 0 and show the result is not married.
	married = 0; // 0 here will mean someone is NOT married
	
	printf("\nIt look likes someone is %s", married ? "married.\n" : "not married.\n");
	return 0;
}
